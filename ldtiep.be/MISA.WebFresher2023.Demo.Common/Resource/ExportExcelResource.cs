    ...
    public static class ExportExcelResource
    {
        ...
        public static string Header(string Field)
        {
            return Field switch
            {
                ...
                "BankProductNumber" => "Số tài khoản",
                "NameOfBank" => "Tên ngân hàng",
                "BankProductBranch" => "Chi nhánh ngân hàng",
                ...
                // Product
                "ProductCode" => "Số tài khoản",
                "NameVi" => "Tên tài khoản",
                "NameEn" => "Tên tiếng anh",
                "ProductPropertyName" => "Tính chất",
                "HasForeignCurrencyProducting" => "Có hạch toán ngoại tệ",
                ...
                "Unit" => "Đơn vị",
                "BankProduct" => "Tài khoản ngân hàng",
        ...
        public static string FileName(string table)
        {
            return table switch
            {
                ...
                "Product" => "Danh_sach_tai_khoan.xlsx",
                _ => "Danh_sach.xlsx",
            };
        }
        /// <summary>
